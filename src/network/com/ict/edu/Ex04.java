...
// 파싱 : 구분분석, 문장을 이루고 있는 구성 성분을 분해하고 분래된 성분의 관계를 분석하여 구조를 결정하는 것
//       즉 데이터를 분해 분석하여 원하는 형태로 조립하고, 다시 뺴는 과정을 말한다.
// HTML : Hyper Text MarkUp Language  => 하이퍼 텍스트 마크업 언어
// XML  : eXtensiable MarkUp Language => 확자된 마크업 언어
//        사용자가 태그를 마늘어서 사용하는 언어
// 태그  :  <시작테그 속성="값" 속성="값" > 텍스트 </끝태그>
...
public class Ex04 {
	public static void main(String[] args) {
		...
		// 파일 쓰기
		String pathname = "D:" + File.separator + "KIM.JH" + File.separator + "오늘날씨.txt";
