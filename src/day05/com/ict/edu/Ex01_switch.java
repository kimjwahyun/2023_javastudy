...
public class Ex01_switch {
	public static void main(String[] args) {
		/* switch ~ case : 다주 if~else 문과 같은 조건문
		...
		// char k3이 A, a, 1  이면 아프리카, B, b, 2 이면 브라질, C, c, 3 이면 캐나다 나머지 한국
		char k3 = '2';
		switch (k3) {
			case 'A':                           // 대문자 A는 수행할문장이 없고, break도 없어서 밑에있는 소문자 a의 결과문에 따른다.
			case 'a':                           // 또는 = or관계 or관계는 위아래로 붙어서 써야한다. 
		...
		// int k5 가 3~5 : 봄, 6~8 : 여름, 9~11 : 가을, 12,1,2 : 겨율 출력하는 코딩
		int k5 = 12 ;
		switch (k5) {
			case 3: 
			case 4: 
