...
//		setBounds(ds.width/2-300, ds.height/2-200, 600, 300);
	...
	public void itemStateChanged(ItemEvent e) {
		// bg1에 존재하는 요소들을 배열(?)로 만든다. 배열은 아니고 배열처럼 생각해라
		...
		// bg2에 존재하는 요소들을 배열(?)로 만든다. 배열은 아니고 배열처럼 생각해라
		...
		// bg3에 존재하는 요소들을 배열(?)로 만든다. 배열은 아니고 배열처럼 생각해라
