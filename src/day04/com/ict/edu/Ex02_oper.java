...
public class Ex02_oper {
	public static void main(String[] args) {
		...
		// 형식)  자료형 변수이름 = (조건식1) ? ((조건식2) ? 조건식2가 참일때 : 조건식2이 거짓일때) : 조건식1이 거짓일때
		// 형식)  자료형 변수이름 = (조건식1) ? 조건식1이 참일때 : ((조건식2) ? 조건식2가 참일때 : 조건식2이 거짓일때)
		...
		// int k3이 1 또는 3 이면 남자, 2또는 4 이면 여자 
		//         1 또는 2 1900년대 태어남, 3 또는 4 2000년 태어남, 나머지는 외국인
		int k3 = 2 ; 
		str = (k3 == 1 || k3 == 3 )? (k3 ==1)? "1900년대 태어난 남자" : "2000년대 태어난남자" : 
